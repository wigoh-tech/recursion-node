...
5. Incase tagname start as wow-*, include all styles from computes styles that apply to the tag too
...
// </head>
// <body>
//     <h1>Migrated Website Sections</h1>
//     ${allSections.map(section => `
//         <div class="section-container">
//             <div class="section-header">Section ${section.index}</div>
//             ${section.html}
//         </div>
//     `).join('\n')}
// </body>
