...
//   },
//   "attributes": {
//     // All HTML attributes except class and id
//   }
// }
...
//           {
//             role: 'system',
//             content: 'You are an HTML/CSS processing expert. Extract widget styles and attributes. Return only valid JSON.'
//           },
//           {
//             role: 'user',
//             content: prompt
...
//       console.log(`→ Reduced to ${optimizedDivCount} divs (${Math.round((1 - optimizedDivCount/originalDivCount)*100)}% reduction)`);
//     }
...
class WebsiteBuilder {
    constructor(outputDir) {
        ...
        this.data2File = path.join(outputDir, 'template_section_placeholders.json'); // Will be set dynamically
