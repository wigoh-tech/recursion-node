...
//         // Open the browser directly with the HTML content
//         const open = require('open');
//         const htmlToShow = `
// <!DOCTYPE html>
// <html>
// <head>
//     <title>Generated Section ${sectionIndex}</title>
//     <style>
//         body { margin: 0; padding: 0; }
//         .section-container { width: 100%; height: 100vh; }
//     </style>
// </head>
// <body>
...
//         const tempFile = path.join(outputDir, `temp_section_${sectionIndex}.html`);
//         await fs.writeFile(tempFile, htmlToShow);
        
//         // Open in default browser
//         await open(tempFile, { wait: false });
        
//         console.log(`   ✅ Final website assembled and opened in browser`);
...
async function assembleFinalWebsite(sectionIndex, outputDir) {
    ...
    try {
        ...
        try {
            ...
            console.log(`   ✅ Final website assembled at: ${fileUrl}`);
